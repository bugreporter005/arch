...
mkdir -p /mnt/{boot/efi,home,root/.cryptkey}
...
arch-chroot /mnt grub-install --target=x86_64-efi --efi-directory=/boot/efi --bootloader-id=GRUB --modules="btrfs zstd part_gpt"
